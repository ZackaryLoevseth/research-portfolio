...
database- and version-scoped. None of the packages claims absolute novelty,
historical priority, peer review, or external independent review.
...
- Wildfire GIS is a public-safe applied summary without a released dataset,
  validated predictive model, or causal-effectiveness claim.

See [research.html](research.html), [methods.html](methods.html), and
[applied.html](applied.html) for the public status pages and linked briefs.
...
- [Public asset registry (TSV)](PUBLIC_ASSETS.tsv)
- [Public asset registry (JSON)](PUBLIC_ASSETS.json)
- [Complete public-site release manifest](PUBLIC_SITE_RELEASE_MANIFEST.tsv)
- [Public-site checksums](PUBLIC_SITE_SHA256SUMS)
- [Repository checksums](SHA256SUMS)

Mixed-rights archives, private-control records, Drive identifiers, internal
action maps, credentials, and owner-only evidence are excluded.
