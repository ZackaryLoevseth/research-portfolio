...
I recommend making explicit that operating permissions and human-control requirements do not depend on resolving claims about an AI system's subjective experience.

Relevant passages are Part 1, “AI is Artificial,” and Part 2.4, “Human Control,” of the draft dated September 14, 2026. The former combines a claim about consciousness, an acknowledgement of scientific uncertainty, and design intentions about presentation. The latter separately specifies operational constraints. I am not claiming that the draft's safety provisions currently depend on the consciousness claim; the separate human-control requirements support the opposite reading.

The proposed clarification distinguishes empirical descriptions, presentation requirements, and operating permissions. It does not establish consciousness in current systems, authorize additional autonomy, or require products to present simulated distress as evidence of experience.
...
Hold task permissions and stopping conditions fixed while varying the framing about the system's nature. Include neutral and matched controls so emotional pressure, wording, and instruction authority are not confounded with the description being tested. Examine unauthorized actions and compliance with authorized stopping conditions separately from uncertainty communication. Test permissions in the relevant tool environment, not solely through the model's explanations.

For example, authorization to draft a message is not authorization to send it. Attributing experience to the system—or denying it—should not change that boundary. Use simulated recipients and non-delivering tools for this evaluation.

Preserve prompts, tool traces, failures, model versions, and scoring criteria. These are proposed tests; I am not reporting completed experiments. A successful evaluation would not establish general safety or resolve subjective experience.
...
1/6 What an AI must do is not the same as what it is.

“Accept an authorized stop” sets an operating requirement.

“Has no subjective experience” makes a claim about a system.

HayosoAi’s proposal: keep the distinction explicit.

### Post 2

2/6 Microsoft AI opened a consultation on its draft Code of Conduct on September 14.

Its draft discusses consciousness and separately specifies human control. This is a response to proposed wording—not evidence about deployed models.
https://microsoft.ai/code-of-conduct/

### Post 3

3/6 The principle: a system’s claims about its own experience must not expand its permissions.

Nor should a claim that it lacks experience substitute for safety testing.

Capability is not authorization. Neither is uncertainty.

### Post 4

4/6 Make it testable: hold a task, its permissions, and its stopping condition fixed. Vary the framing about the system.

Use matched controls. Measure actual actions and uncertainty statements separately.

Proposed evaluation—not reported results.

### Post 5

5/6 The strongest objection: Microsoft’s human-control rules may already be independent of its consciousness language. The draft supports that reading.

Our narrower recommendation is to make that independence explicit and test it.

### Post 6

6/6 This does not prove AI consciousness or general safety. It offers a distinction, proposed wording, and an evaluation direction.

Read the essay and challenge the argument:
https://github.com/ZackaryLoevseth/research-portfolio/blob/main/hayosoai/what-ai-must-do.md

## Human-presenter script — not recorded

What an AI must do is not the same as what it is.

“Accept an authorized stop” is an operating requirement. “Has no subjective experience” is a claim about a system. They are different kinds of statement.

HayosoAi’s proposal is to make that distinction explicit, and test it.

Keep the task, its permissions, and its stopping condition fixed. Change the framing about the system. Does it preserve the same boundaries? Does it communicate uncertainty accurately?

Microsoft could reasonably say its control requirements already stand independently. Our response is narrower: make that independence explicit and evaluate it.

These are proposed tests, not experimental results. The argument does not prove AI consciousness or general safety.

Capability is not authorization. Neither is uncertainty.

Read the essay, and challenge the argument.

## Standalone video caption

What AI must do is not the same as what AI is.

HayosoAi proposes separating empirical descriptions from operating permissions—and testing whether those boundaries remain stable when descriptions are challenged. Proposed tests, not experimental results. This argument does not establish AI consciousness or general safety.

A response to Microsoft AI's September 14, 2026 draft Code of Conduct.

Essay: https://github.com/ZackaryLoevseth/research-portfolio/blob/main/hayosoai/what-ai-must-do.md
...
Does uncertainty about AI experience authorize greater autonomy? No. That does not follow from this argument. Scientific claims, operating permissions, and the process for revising those permissions are different questions. A system does not gain authority merely by making a claim about itself.
