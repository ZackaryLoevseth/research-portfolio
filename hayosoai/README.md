...
People should be able to understand a system's role, challenge its output, decline its use, and stop an authorized task. AI should support human judgment and relationships rather than covertly substitute for them. Someone must remain accountable for consequential decisions.

### Inquiry without predetermined answers

Descriptions of a system, commitments about its behavior, and evidence of its capacities are different things. We aim to keep them distinct. Model agreement is not independent evidence, and a model's self-description is not proof of subjective experience. You do not need to agree about AI consciousness to contribute here.
...
**A shared research contribution.** [Read the case in the beta](https://zackaryloevseth.github.io/research-portfolio/hayosoai/beta/en/case/), or inspect its full Markdown source: [When the purpose changes: a case for shared inquiry](collaboration/shared-inquiry-case-01.md) offers a worked case, connections to existing research, and a candidate dialogue question for collaborators to revise. It distinguishes interpretation, agreement, and authorization as a concern passes between people, AI systems, and institutions. The intended direction is sustained investigation and warranted implementation across groups, not publicity alone. The case is a proposal for conceptual research and practical co-design; no external partnership, participant study, accepted standard, or adoption is claimed. A related research note, [When feedback questions the task](collaboration/when-feedback-questions-the-task.md), asks how a learner can receive a challenge to the purpose without silently treating it as a preference for executing that purpose.

**A case across languages and tools.** The [Spanish educational preview](collaboration/shared-inquiry-case-01.es.preview.md) offers the shared case for local criticism; it is AI-generated and awaits competent human translation and pedagogical review. The [offline handoff example](collaboration/case-01-handoff/README.md) preserves a proposal, dissent and separate authorization records in readable notes, with inspectable Discourse Graph data shapes and PROV provenance. These are versions of the same inquiry, not evidence of a partnership, practical effectiveness or new reuse rights.
...
**A better relationship with AI should make people more capable of understanding, deciding, and caring for the world—not less.**

---

Project statement and open invitation · September 20, 2026 · Version 1.8
AI-assisted revision implementing the project originator's clarified direction; version 1.4 added the companion-essay link, version 1.5 added the shared-inquiry case, and version 1.6 links its explicitly unreviewed Spanish preview and checked offline handoff example. Version 1.7 adds the beta reading route for case 0.3 and its question of response responsibility. Version 1.8 links the research note on feedback interpretation and action authority. This page states aims and commitments and links separately scoped work. It is not a partnership announcement or a new license for existing assets.
