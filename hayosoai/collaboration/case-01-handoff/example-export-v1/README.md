...
- [Developing a purpose without merging kinds of change](notes/question.md) — question
- [Native planting proposal — History A](notes/proposal-a.md) — proposal
- [Native planting proposal — History B](notes/proposal-b.md) — proposal
- [Food production remains a concern](notes/food-objection.md) — objection
- [A seasonal estimate is corrected](notes/water-premise.md) — stipulated-premise
- [History A — implementation not authorized](notes/standing-a.md) — permission-record
- [History B — limited trial is stipulated](notes/standing-b.md) — permission-record
- [Exact trial scope remains unrecorded](notes/trial-scope-unknown.md) — permission-record
- [Assistant may prepare proposals only](notes/assistant-boundary.md) — permission-record
- [Leaving the AI discussion retains an objection](notes/nonparticipation.md) — stipulated-premise
